        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="m-0">
                        <a href="<?php echo base_url('/pendidikan/tambah') ?>" class="btn btn-sm btn-primary"><i
                ...
                <div class="card-body">
                    <div class="table-responsive" cellpadding="0" cellspacing="0">
                        <table class="table table-bordered font-weight-bold" id="dataTable" width="100%" cellspacing="0"
                            ...
                            <tbody>
                                <?php if ($pendidikan) : ?>
                                    <?php foreach ($pendidikan as $i => $p) : ?>
                                        <tr>
                                            <td><?= $i + 1 ?></td>
                                            <td><?= $p['nama'] ?></td>
                                            <td style="text-align: center;">
                                                <a href="<?= base_url('pendidikan/edit/' . $p['id']) ?>"
                                                    class="badge badge-primary p-2">Ubah</a> 
                                                <a href="<?= base_url('pendidikan/delete/' . $p['id']) ?>"
